export enum JobType {
  ...
  DISPATCH_GOAL_COMPLETED_DISCORD_EVENT = 'dispatch-goal-completed-discord-event',
  DISPATCH_MILESTONE_ACHIEVED_DISCORD_EVENT = 'dispatch-milestone-achieved-discord-event',
  ...
  EXPIRE_PLAYER_GOALS = 'expire-player-goals',
  SYNC_PLAYER_ACHIEVEMENTS = 'sync-player-achievements',
  SYNC_PLAYER_GOALS = 'sync-player-goals',
